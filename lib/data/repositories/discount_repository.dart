...
class InMemoryDiscountRepository implements DiscountRepository {
  ...
  // Use this skeleton when wiring the repository to Firestore.
  //
  // import 'package:cloud_firestore/cloud_firestore.dart';
  //
  // class FirestoreDiscountRepository implements DiscountRepository {
  //   FirestoreDiscountRepository(this._firestore);
  //
  //   final FirebaseFirestore _firestore;
  //
  //   @override
  //   Future<List<DiscountDeal>> getDeals() async {
  //     final snapshot = await _firestore.collection('deals').get();
  //     return snapshot.docs
  //         .map((doc) => DiscountDeal.fromMap(doc.data(), id: doc.id))
  //         .toList();
  //   }
  // }
